...
class CloudBuyAnalyzer(BaseAnalyzer):
    """Cloud-optimized Buy analyzer with transfer storage"""
    ...
    async def _process_data(self, wallets: List[WalletInfo], 
        ...
        """Process transfers to identify buy transactions and store all transfers"""
        
        # Convert transfers to purchases - this will now also store all transfers
